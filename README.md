...
- [Features](https://droserasprout.github.io/gtk-brotway/features/clipboard.html) - clipboard, touch, pinch-zoom, reconnect, dynamic cursor, HiDPI, plus the [backend comparison](https://droserasprout.github.io/gtk-brotway/features/comparison.html) matrix
...
Same as GTK: GNU Lesser General Public License, version 2.1 or later (`LGPL-2.1-or-later`). The patches inherit the license of the files they modify; see [`COPYING`](COPYING).

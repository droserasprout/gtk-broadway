...
**SONAME** - the versioned shared-object name (e.g. `libgtk-4.so.1.2200.4`). The `.deb` replaces this file in place, so the package base and the system GTK must match. See [Requirements](guide/requirements.md).

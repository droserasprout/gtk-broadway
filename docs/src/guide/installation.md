...
```dockerfile
FROM ghcr.io/droserasprout/gtk-brotway:v3.1.0   # or :latest
...
Asset names are `gtk4-brotway_<gtk>-<rev>_<arch>.deb` (e.g. `gtk4-brotway_4.22.4-3.1.0_amd64.deb`). Uninstall with `apt-get remove gtk4-brotway`.
